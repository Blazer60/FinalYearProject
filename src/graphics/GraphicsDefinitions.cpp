...
namespace graphics
{
    ...
    constexpr int gbufferToInt[] { DEBUG_GBUFFER_NORMAL, DEBUG_GBUFFER_ROUGHNESS, DEBUG_GBUFFER_DIFFUSE, DEBUG_GBUFFER_SPECULAR, DEBUG_GBUFFER_EMISSIVE, DEBUG_GBUFFER_BYTE_COUNT };
