...
namespace graphics
{
    ...
    constexpr int gbufferToInt[]
    {
        ...
        DEBUG_GBUFFER_FUZZ_COLOUR, DEBUG_GBUFFER_FUZZ_ROUGHNESS, DEBUG_GBUFFER_TOP_NORMAL,
        DEBUG_GBUFFER_TOP_SPECULAR, DEBUG_GBUFFER_TOP_ROUGHNESS, DEBUG_GBUFFER_TOP_COVERAGE,
        DEBUG_GBUFFER_TOP_THICKNESS, DEBUG_GBUFFER_TRANSMITTANCE
    };

    constexpr GLenum formatToEnum[] { GL_RGBA16F, GL_RG16F, GL_R16F, GL_DEPTH_COMPONENT32F, GL_RGBA16, GL_RGBA32UI, GL_RGBA8, GL_R16, GL_RG16 };
